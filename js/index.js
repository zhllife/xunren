$(document).ready(function () {
    ...
    if (isAndroid) {
        ...
        var endHTML =
            ...
            '</div>' +
            '<div id="sharebox" style="position: absolute;left: 0;top: 0;width: 100%;height: 100%;display: none; background: rgba(0, 0, 0, 0.9)">' +
            '<img src="./images/002.gif" alt="" id="whitekedou" style="position: absolute;right:5%;top: 4%;width: 10%;transform: rotate(30deg)">' +
            '<img src="images/next.png" alt="" id="next" style="position: absolute;right: 14%;top: 4%;width: 44%">' +
            '</div>';
        ...
        if(line){
            line.addEventListener("click", function () {
                _hmt.push(['_trackEvent', "baidu", "click", "001"]);
